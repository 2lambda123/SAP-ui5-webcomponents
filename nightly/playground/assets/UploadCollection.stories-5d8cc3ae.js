...
${a("Notes.txt",!1,t.Complete,"Uploaded By: John Smith · Uploaded On: 2014-09-02 · File Size: 226.6 KB",'<ui5-icon name="document-text" slot="thumbnail"></ui5-icon>',c.Detail)}`};d.decorators=[W,u];const X=e=>r(T||(T=s(["",`
...
}`,...(H=(E=d.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};var N,w,O;n.parameters={...n.parameters,docs:{...(N=n.parameters)==null?void 0:N.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(O=(w=n.parameters)==null?void 0:w.docs)==null?void 0:O.source}}};var I,_,F;o.parameters={...o.parameters,docs:{...(I=o.parameters)==null?void 0:I.docs,source:{originalSource:`args => {
  return html\`
<ui5-upload-collection
    id="\${ifDefined(args.id)}"
    mode="\${ifDefined(args.mode)}"
...
}`,...(F=(_=o.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};const De=["Basic","RenamingFiles","VariousUploadStates","DragAndDrop"];export{i as Basic,o as DragAndDrop,d as RenamingFiles,n as VariousUploadStates,De as __namedExportsOrder,ve as default};
